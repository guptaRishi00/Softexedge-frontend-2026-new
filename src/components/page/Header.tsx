    ...
    <div className="flex items-center justify-between py-12 px-16">
      ...
      <div className="flex items-center justify-center gap-10">
        ...
        <div className="relative group">
          ...
          <div className="absolute top-10 left-0 bg-white rounded-xl shadow-lg py-3 w-48 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 ease-out">
        ...
        <div className="relative group">
          ...
          <div className="absolute top-10 left-0 bg-white rounded-xl shadow-lg py-3 w-56 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 ease-out">
            <Link
      ...
      <Link
        href={"/"}
        className="bg-linear-to-r text-md lg:px-7 font-medium lg:py-3 rounded-full hover:opacity-90 from-[#3445E7] via-[#2F85EA] to-[#07D6F3] text-white transition-all duration-300"
      >
        Let's Talk
      </Link>
    </div>
