          ...
          <div className="lg:flex lg:gap-6 flex-col lg:flex-row flex items-center gap-3 justify-center lg:mt-10">
            {data?.letsTalk && (
              <Link
                ...
                className="bg-transparent ring-1 font-medium ring-white text-white text-md lg:px-7 lg:py-3 rounded-full  hover:bg-linear-to-r hover:from-[#3445E7] hover:via-[#2F85EA] hover:to-[#07D6F3] hover:ring-transparent hover:text-white"
              >
                {data.letsTalk.text}
              </Link>
            )}
