      ...
      <div className="flex flex-col lg:flex-row gap-12 items-center">
        ...
        <div className="flex-1 flex flex-col gap-8">
          ...
          {data.cta && (
            <Link
              href={`/${data.cta.href}`}
              className="w-fit text-white font-bold px-10 py-4 rounded-full bg-linear-to-r from-[#3445E7] via-[#2F85EA] to-[#07D6F3] hover:scale-105 transition-all duration-300 shadow-lg"
            >
              {data.cta.text}
            </Link>
          )}
